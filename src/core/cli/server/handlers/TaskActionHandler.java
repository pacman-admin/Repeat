...
public abstract class TaskActionHandler extends HttpHandlerWithBackend {
	...
	final UserDefinedAction getTask(TaskGroup group, TaskIdentifier taskIdentifier) {
	...
	final TaskGroup getGroup(TaskIdentifier taskIdentifier) {
		return getGroup(taskIdentifier.getGroup());
	}

	final TaskGroup getGroup(TaskGroupMessage taskGroup) {
