...
public final class PythonSourceGenerator extends AbstractSourceGenerator {
	...
	public PythonSourceGenerator() {
		...
		this.sourceScheduler.setSleepSource(new Function<>() {
            ...
            public String apply(Long r) {
                return TAB + "time.sleep(" + (r.floatValue() / 1000f) + ")";
            }
        });
	}
	...
	private final class PythonMouseSourceCodeGenerator extends AbstractMouseSourceCodeGenerator {
	...
	private final class PythonKeyboardSourceCodeGenerator extends AbstractKeyboardSourceCodeGenerator {
