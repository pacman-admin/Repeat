...
public final class RemoteRepeatsCompiler extends AbstractCompiler {

	private static final Logger LOGGER = Logger.getLogger(RemoteRepeatsCompiler.class.getName());

	private final RemoteRepeatsCompilerConfig config;
	private final RepeatsPeerServiceClientManager clients;
