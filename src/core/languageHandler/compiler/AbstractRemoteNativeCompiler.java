...
public abstract class AbstractRemoteNativeCompiler extends AbstractNativeCompiler {
	...
	private TaskProcessor remoteTaskManager;
	private File objectFileDirectory;

    AbstractRemoteNativeCompiler(File objectFileDirectory) {
	...
	private DynamicCompilationResult loadAction(final String id, final String source, File objectFile) {
