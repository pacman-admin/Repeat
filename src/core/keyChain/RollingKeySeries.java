 ...
 * {@link KeyStroke}s and will remove the last one.
 */
public final class RollingKeySeries extends KeySeries {
    ...
    /**
     * Add all {@link KeyStroke}s from another {@link KeySeries}.
     */
    @Override
    ...
    /**
     * Add a single stroke to the {@link KeySeries}.
     *
    ...
    /**
     * @return last {@link KeyStroke} in the series.
     */
     ...
     * Note that this includes effects of keys like SHIFT, CAPSLOCK, or NUMLOCK.
     ...
     * Checks whether the pressing {@link KeyStroke}s in this object in the specified order
