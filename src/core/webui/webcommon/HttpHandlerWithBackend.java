...
public abstract class HttpHandlerWithBackend implements HttpAsyncRequestHandler<HttpRequest> {
	...
	public final synchronized void setMainBackEndHolder(MainBackEndHolder backEndHolder) {
	...
	@Override
	public final HttpAsyncRequestConsumer<HttpRequest> processRequest(HttpRequest request, HttpContext context)
			throws HttpException, IOException {
