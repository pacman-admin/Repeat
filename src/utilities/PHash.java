...
final class PHash {
    ...
    private String getHash(BufferedImage img) {
        /* 1. Reduce size.
         ...
         */
        img = grayscale(resize(img, size, size));
        ...
        //LOGGER.info("DCT: " + (System.currentTimeMillis() - start));
    ...
    private double getAvg(double[][] dctVals) {
        double total = 0;
