...
public final class Jsonizer {
    ...
    private static JsonNode fromPrimitiveOrString(Class<?> clazz, Object value) {
        if (clazz == String.class) {
            ...
            return JsonNodeFactories.string(Character.toString((Character) value));
        } else if (clazz == Short.class) {
            return JsonNodeFactories.number((Short) value);
        } else if (clazz == Integer.class) {
            return JsonNodeFactories.number((Integer) value);
    ...
    private static boolean isPrimitiveOrString(Class<?> clazz) {
        return isString(clazz) || clazz == Boolean.class || clazz == Boolean.TYPE || clazz == Byte.class || clazz == Byte.TYPE || clazz == Character.class || clazz == Character.TYPE || clazz == Short.class || clazz == Short.TYPE || clazz == Integer.class || clazz == Integer.TYPE || clazz == Long.class || clazz == Long.TYPE || clazz == Float.class || clazz == Float.TYPE || clazz == Double.class || clazz == Double.TYPE;
    }
