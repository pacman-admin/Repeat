...
@SuppressWarnings({"unused", "BooleanMethodIsAlwaysInverted", "DanglingJavadoc"})

public final class KeyChainInputPanel extends JPanel {

    private static final int MAX_KEY_CHAIN = 15;

    private static final ReentrantLock inUse = new ReentrantLock();

    private final JTextField tfPhrase;
    private final List<ButtonStroke> keyStrokes;
    ...
    private static TaskActivation getInputKeyChains(JFrame parent, int limit, TaskActivation prepopulated, Mode mode) {
        ...
        try {
            ...
            if (value == JOptionPane.YES_OPTION) {
                ...
                Set<MouseGesture> gestures = new HashSet<>(input.mouseGestureList.getSelectedValuesList());
