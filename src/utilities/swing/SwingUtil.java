...
public final class SwingUtil {
    ...
    static final class TableUtil {
        ...
        static final class TableSearcher {
    ...
    private static final class OptionPaneUtil {
         ...
         * @param selected index of the selected element at start time. If set to -1
         ...
         * @return an array of input values entered by user, or null if user cancels input windows
         */
        public static String[] getInputs(String[] titles) {
            ...
            int result = JOptionPane.showConfirmDialog(null, mainPanel, "Enter values", JOptionPane.OK_CANCEL_OPTION);
    ...
    public static final class DialogUtil {
        ...
        private static void getFocus(Window w) {
        ...
        public static final class DialogSelectionOption {
